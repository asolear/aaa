...
\def\h{2}
Promotor \hspace{6cm} Segundo texto\\[0.05em]
\TextField[multiline=true, bordercolor=gray!30,name=beee,width=0.5\textwidth,height=\h cm,default=boo]{}
\TextField[multiline=true, bordercolor=gray!30,name=beee,width=0.5\textwidth,height=\h cm,default=boo]{}
% 
...
Titulo  \\
\def\h{1}
\TextField[multiline=true, bordercolor=gray!30,name=beee,width=1\textwidth,height=\h cm,default=boo]{}
% 
...
\begin{titlepage}
    ...
    {\scshape\LARGE  \par}
    \vspace{1cm}
    {\Huge\bfseries Norma UNE 50135: Año\par}
    \vspace{2cm}
