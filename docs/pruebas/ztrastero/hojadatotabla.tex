...
\vspace{1cm}
\textcolor{gray!30}{\rule{\textwidth}{0.05pt}}

Primer texto \hspace{6cm} Segundo texto

\TextField[multiline=true,name=beee,width=8cm,height=2cm,default=boo]{}
\textcolor{gray!30}{\rule{0.4pt}{2.5cm}}
\TextField[multiline=true,name=beee,width=8cm,height=2cm,default=boo]{}
