...
\newcommand{\camino}{../../../assets/settings}
\input{\camino/newcommand.tex}
\input{\camino/preambuloUNE.tex}
% \input{\camino/preambulo.tex}
\usepackage{nopageno} % Paquete para desactivar la numeración de páginas

\title{FV030 Rentabilidad de una bateria}
\begin{document}
\maketitle
\cuadroPortada
\newpage
